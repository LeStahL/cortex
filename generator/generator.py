...
f.write("\n")
f.write("LoadingBar::LoadingBar(SymbolTable *_symbolTable, Window *_window)\n")
f.write("    : symbolTable(_symbolTable)\n")
f.write("    , window(_window)\n")
f.write("    , nShaderTasks(0)\n")
f.write("    , nProgramTasks(0)\n")
f.write("    , shaderTasks(nullptr)\n")
f.write("    , programTasks(nullptr)\n")
